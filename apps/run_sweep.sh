...
sudo ../sensitivity_sweep.sh kv-32GB-zipf1_2-sp 0 8 8192 "./build/kv_benchmark --num_pages 8000000 --queries 160000000 -t 8 -z 1.2 --dist zipfian -s 0.1 -v 10 -d 120 --cache_locality 1";
sudo ../sensitivity_sweep.sh kv-32GB-zipf1_2-dn 0 8 8192 "./build/kv_benchmark --num_pages 8000000 --queries 160000000 -t 8 -z 1.2 --dist zipfian -s 0.9 -v 10 -d 120 --cache_locality 1";
popd
