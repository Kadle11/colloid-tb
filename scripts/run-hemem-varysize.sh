...
# for b in 0 5 10 15; do for i in 15; do sudo MIO_STATS="--stats_colloid --stats_colloid_cha --ant_prestart_duration 140" ./hemem.sh icx-eval-hemem-gups256-rw-app$i-bg$b 180 $i $b -- /home/midhul/colloid/apps/gups/gups256-rw $i; done; done;

# for b in 0 5 10 15; do for i in 15; do sudo MIO_STATS="--stats_colloid --stats_colloid_cha --ant_prestart_duration 140" ./hemem.sh icx-eval-hemem-gups1024-rw-app$i-bg$b 180 $i $b -- /home/midhul/colloid/apps/gups/gups1024-rw $i; done; done;

# for b in 0 5 10 15; do for i in 15; do sudo MIO_STATS="--stats_colloid --stats_colloid_cha --ant_prestart_duration 140" ./hemem.sh icx-eval-hemem-gups-rw-app$i-bg$b 180 $i $b -- /home/midhul/colloid/apps/gups/gups-rw $i; done; done;
